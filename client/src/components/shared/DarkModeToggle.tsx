...
export default function DarkModeToggle({ showLabel = true }: DarkModeToggleProps) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        className={`w-10.5 h-6 rounded-full transition-all duration-300 cursor-pointer border-none ${
      ...
      >
        <span
          className={`absolute top-8 w-4.5 h-4.5 bg-white rounded-full shadow-sm transition-all duration-300 flex items-center justify-center ${
