        ...
        <div className="flex flex-col gap-5">
            ...
            <div className="card bg-primary/5 border-primary/20">
                <div className="flex items-start gap-3 mb-4">
                    <div className={`w-12 h-12 rounded-lg flex items-center justify-center shrink-0 ${isPast ? 'bg-text-muted/10' : 'bg-primary/10'
                        }`}>
            ...
            <div className="flex items-center gap-2 border-b border-border">
                <button
                    className={`px-4 py-2 text-sm font-semibold transition-all border-b-2 ${activeTab === 'tasks'
                ...
                <button
                    className={`px-4 py-2 text-sm font-semibold transition-all border-b-2 ${activeTab === 'resources'
                            ? 'border-primary text-primary'
                            : 'border-transparent text-text-secondary hover:text-text-primary'
                        }`}
                ...
                <button
                    className={`px-4 py-2 text-sm font-semibold transition-all border-b-2 ${activeTab === 'attendance'
                            ? 'border-primary text-primary'
                            : 'border-transparent text-text-secondary hover:text-text-primary'
                        }`}
                ...
                <button
                    className={`px-4 py-2 text-sm font-semibold transition-all border-b-2 ${activeTab === 'feedback'
                            ? 'border-primary text-primary'
                            : 'border-transparent text-text-secondary hover:text-text-primary'
                        }`}
                ...
                return (
                    <div key={task._id} className="card">
                        <div className="flex items-start justify-between mb-3">
                            ...
                            <span className={`text-xs font-bold px-2.5 py-1 rounded-full capitalize ${task.type === 'assignment' ? 'bg-primary/10 text-primary' :
            ...
            <div className="card">
                ...
                {myAttendance ? (
                    <div className="flex items-center gap-3 p-3 rounded-lg bg-bg-hover">
                        <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${myAttendance.status === 'present' ? 'bg-success/10' :
