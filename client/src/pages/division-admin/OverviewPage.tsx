...
import { Users, Calendar, CheckCircle, BookOpen, TrendingUp, ClipboardList, Star } from 'lucide-react';
import { selectActiveDivisionId } from '../../features/auth/authSlice';
import { useDashboardStats } from '../../features/reports/reportsApi';

export default function DivisionAdminOverviewPage() {
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="card">
          ...
          <div className="text-xs font-semibold text-info">In your division</div>
        </div>
        ...
        <div className="card">
          ...
          <div className="text-xs font-semibold text-info">Active programs</div>
        </div>
        ...
        <div className="card">
          ...
          <div className="text-xs font-semibold text-info">Scheduled</div>
        </div>
        ...
        <div className="card">
          ...
          <div className={`flex items-center gap-1 text-xs font-semibold ${
            parseInt(overview.avgAttendance) >= 80 ? 'text-success' : 'text-warning'
          }`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="card bg-primary/5 border-primary/20 hover:border-primary/40 transition-all cursor-pointer">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-bold text-text-primary">Manage Bootcamps</div>
              <div className="text-xs text-text-muted">View and manage your bootcamps</div>
            </div>
          </div>
        </div>
        ...
        <div className="card bg-success/5 border-success/20 hover:border-success/40 transition-all cursor-pointer">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-bold text-text-primary">View Students</div>
              <div className="text-xs text-text-muted">Manage student enrollments</div>
            </div>
          </div>
        </div>
        ...
        <div className="card bg-info/5 border-info/20 hover:border-info/40 transition-all cursor-pointer">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-bold text-text-primary">Attendance Analytics</div>
              <div className="text-xs text-text-muted">Track attendance trends</div>
            </div>
          </div>
        </div>
      </div>
